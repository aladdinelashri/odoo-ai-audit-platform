...
from database.core.business_unit import BusinessUnitResolverFactory
...
class MissingReceiptsAudit(BaseAudit):
    ...
    def __init__(self):
        ...
        self.business_unit_resolver = (
            BusinessUnitResolverFactory.create()
        )
    ...
    def analyze(self, limit=5000):
        ...
        for order in orders:
            ...
            business_unit = self.business_unit_resolver.resolve(order)
